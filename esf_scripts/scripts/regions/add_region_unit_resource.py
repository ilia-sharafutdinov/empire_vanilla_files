...
def add_region_unit_resource(region_name: VANILLA_REGION_KEY_HINTS, new_resource: str):
    '''
    example:
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        ...
        description='',
        epilog='example:\n' +
        '  python add_region_unit_resource.py ceylon camels')
    ...
    add_region_unit_resource(region_name, new_resource)
