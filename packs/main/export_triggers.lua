...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterWasAttacker(context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Attacker_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Attacker_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Bad", "agent", 1, 100, context)
		effect.trait("C_Admiral_Boring_Speaker", "agent", 1, 50, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CampaignBattleType("naval_blockade", context) and not conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Blockader_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CommanderFoughtInBattle(context) and not conditions.CharacterRouted(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Brave", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterRouted(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Coward", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterWonBattle(context) and conditions.CampaignPercentageOfUnitCategory("naval_frigate", context) >= 50 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Cruisers", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and not conditions.CharacterWasAttacker(context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Defender_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and not conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Defender_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.NoActionThisTurn(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Drunkard", "agent", 1, 17, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and not conditions.CharacterWonBattle(context) and (conditions.BattleResult("crushing_defeat", context) or conditions.CampaignPercentageOfOwnRouted(context) >= 50 or conditions.CampaignPercentageOfOwnKilled(context) >= 50 or conditions.CampaignPercentageOfOwnCaptured(context) >= 30) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Lampooned", "agent", 1, 50, context)
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("admiral", context) and false then
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CharacterWonBattle(context) and (conditions.BattleResult("heroic_victory", context) or conditions.CampaignPercentageOfThemRouted(context) >= 50 or conditions.CampaignPercentageOfThemKilled(context) >= 50 or conditions.CampaignPercentageOfThemCaptured(context) >= 30) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Press_Hero", "agent", 1, 30, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("admiral", context) and not conditions.CharacterCultureType("tribal", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.CharacterFactionAdmiralCount(context) > 15 then
		...
		effect.trait("C_Admiral_Drunkard", "agent", 2, 33, context)
		effect.trait("C_Admiral_Drunkard", "agent", 2, 17, context)
		return true
	end
	return false
...
function (context)
	if conditions.CharacterType("admiral", context) and conditions.CommanderFoughtInMelee(context) and not conditions.CharacterRouted(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Admiral_Swashbuckling", "agent", 1, 20, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("rake", context) and false then
		effect.trait("C_Agent_Secret_Police", "agent", 1, 17, context)
...
function (context)
	if conditions.CharacterType("rake", context) and false then
		effect.trait("C_Agent_Spy_Network", "agent", 1, 17, context)
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.NoActionThisTurn(context) and conditions.InSettlement(context) and not conditions.CharacterType("catholic_missionary", context) and not conditions.CharacterType("indian_missionary", context) and not conditions.CharacterType("middle_east_missionary", context) and not conditions.CharacterType("orthodox_missionary", context) and not conditions.CharacterType("Protestant_Missionary", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CampaignBattleType("land_ambush", context) and conditions.CharacterWasAttacker(context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Ambusher_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CampaignBattleType("land_ambush", context) and conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Ambush_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterInTheatre(1, context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Americas_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterInTheatre(1, context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Americas_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWasAttacker(context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Attacker_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Attacker_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CampaignBattleType("normal", context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Bad_Field_Commander", "agent", 1, 50, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and conditions.CampaignPercentageOfOwnKilled(context) > 40 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Bloody", "agent", 1, 15, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CommanderFoughtInBattle(context) and not conditions.CharacterRouted(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Brave", "agent", 1, 3, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterRouted(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Coward", "agent", 1, 18, context)
		effect.trait("C_General_Bad_Field_Commander", "agent", 1, 1, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and not conditions.CharacterWasAttacker(context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Defender_Bad", "agent", 1, 100, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and not conditions.CharacterWasAttacker(context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Defender_Good", "agent", 1, 100, context)
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("General", context) and conditions.NoActionThisTurn(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Drunkard", "agent", 1, 17, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterInTheatre(3, context) and not conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_India_Bad", "agent", 1, 50, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterInTheatre(3, context) and conditions.CharacterWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_India_Good", "agent", 1, 50, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and not conditions.CharacterWonBattle(context) and (conditions.BattleResult("crushing_defeat", context) or conditions.CampaignPercentageOfOwnRouted(context) >= 50 or conditions.CampaignPercentageOfOwnKilled(context) >= 50 or conditions.CampaignPercentageOfOwnCaptured(context) >= 30) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Lampooned", "agent", 1, 20, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and conditions.CampaignPercentageOfUnitCategory("artillery", context) >= 40 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_of_Artillery", "agent", 1, 33, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and conditions.CampaignPercentageOfUnitCategory("cavalry", context) >= 40 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_of_Cavalry", "agent", 1, 33, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and conditions.CampaignPercentageOfUnitCategory("infantry", context) >= 40 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_of_Infantry", "agent", 1, 7, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and (conditions.BattleResult("heroic_victory", context) or conditions.CampaignPercentageOfThemRouted(context) >= 50 or conditions.CampaignPercentageOfThemKilled(context) >= 50 or conditions.CampaignPercentageOfThemCaptured(context) >= 30) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_General_Press_Hero", "agent", 1, 20, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterType("General", context) and not conditions.CharacterCultureType("tribal", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.CharacterFactionGeneralCount(context) <= 15 and conditions.FactionLeadersTrait("C_Leader_Merit", context) >= 1 then
		effect.trait("C_General_Good_Field_Commander", "agent", 1, 17, context)
		return true
	end
	return false
end
...
events.CharacterCompletedBattle[#events.CharacterCompletedBattle+1] =
function (context)
	if conditions.CharacterType("General", context) and conditions.CharacterWonBattle(context) and conditions.CharacterMPPercentageRemaining(context) == 0 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and conditions.RandomPercentCampaign(21, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Huntin_Shootin_Fishin", context) >= 1 then
		...
		effect.trait("C_Gent_Research_Agriculture", "agent", 2, 17, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Clever_Stick", context) >= 1 then
		...
		effect.trait("C_Gent_Research_Economics", "agent", 2, 17, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Huntin_Shootin_Fishin", context) < 1 then
		...
		effect.trait("C_Gent_Research_Industry", "agent", 2, 17, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Army_Buff", context) >= 1 then
		...
		effect.trait("C_Gent_Research_Military", "agent", 2, 17, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Navy_Buff", context) >= 1 then
		...
		effect.trait("C_Gent_Research_Navy", "agent", 2, 17, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("gentleman", context) or conditions.CharacterType("Eastern_Scholar", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) and conditions.FactionLeadersTrait("C_Leader_Intellectual_Pretensions", context) >= 1 then
		...
		effect.trait("C_Gent_Research_Philosophy", "agent", 2, 17, context)
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("gentleman", context) and conditions.RandomPercentCampaign(21, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Cholera_1_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterInTheatre(3, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Cholera_2_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterInTheatre(2, context) and conditions.RandomPercentCampaign(50, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Cholera_3_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterInTheatre(1, context) and conditions.RandomPercentCampaign(25, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Dengue_Fever_1_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if (conditions.CharacterInTheatre(-1133129049, context) or conditions.CharacterInTheatre(3, context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Dengue_Fever_2_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if (conditions.CharacterInTheatre(1197997136, context) or conditions.CharacterInRegion("bahamas", context) or conditions.CharacterInRegion("cuba", context) or conditions.CharacterInRegion("curacao", context) or conditions.CharacterInRegion("dutch_guyana", context) or conditions.CharacterInRegion("french_guyana", context) or conditions.CharacterInRegion("guatemala", context) or conditions.CharacterInRegion("hispaniola", context) or conditions.CharacterInRegion("jamaica", context) or conditions.CharacterInRegion("leeward_islands", context) or conditions.CharacterInRegion("new_andalusia", context) or conditions.CharacterInRegion("new_grenada", context) or conditions.CharacterInRegion("new_spain", context) or conditions.CharacterInRegion("panama", context) or conditions.CharacterInRegion("trinidad_tobago", context) or conditions.CharacterInRegion("windward_islands", context)) and conditions.RandomPercentCampaign(50, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Dysentry_2_Trigger ]]--
...
--[[ C_Infected_Dysentry_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if (conditions.CharacterInTheatre(2, context) or conditions.CharacterInTheatre(1, context)) and conditions.RandomPercentCampaign(50, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Influenza_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterInTheatre(2, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ C_Infected_Leprosy_Trigger ]]--
...
--[[ C_Infected_Yellow_Fever_Trigger ]]--
...
function (context)
	if (conditions.IsBuildingInChain("army-admin", context) or conditions.IsBuildingInChain("ordnance", context)) and conditions.IsFactionLeader(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if (conditions.ResearchCategory("enlightenment", context) or conditions.ResearchCategory("industry", context)) and conditions.IsFactionLeader(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Leader_Enlightened_Despot", "agent", 1, 8, context)
		return true
	end
	return false
end

--[[ C_Leader_Fertile_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterType("minister", context) and (conditions.IsFactionLeader(context) or conditions.IsFactionLeaderFemale(context)) and conditions.CharacterNumberOfChildren(context) >= 1 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
--[[ C_Leader_Infertile_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.CharacterType("minister", context) and (conditions.IsFactionLeader(context) or conditions.IsFactionLeaderFemale(context)) and conditions.CharacterNumberOfChildren(context) == 0 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if conditions.IsFactionLeader(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Personal_Piety", "agent", 1, 1, context)
		return true
	end
	return false
end
...
events.BuildingCompleted[#events.BuildingCompleted+1] =
function (context)
	if not conditions.IsBuildingInChain("education", context) and not conditions.CharacterTrait("C_Leader_Intellectual_Pretensions", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
...
events.BuildingCompleted[#events.BuildingCompleted+1] =
function (context)
	if conditions.IsBuildingInChain("army-admin", context) and conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("army", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.RandomPercentCampaign(50, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
...
function (context)
	if conditions.CharacterType("minister", context) and not conditions.IsFactionLeader(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		...
		effect.trait("C_Minister_Corrupt", "agent", 1, 17, context)
		effect.trait("C_Minister_Corrupt", "agent", 1, 17, context)
		effect.trait("C_Minister_Corrupt", "agent", 1, 17, context)
		effect.trait("C_Minister_Entertainer", "agent", 1, 17, context)
		effect.trait("C_Minister_Entertainer", "agent", 2, 17, context)
		effect.trait("C_Minister_Physiocrat", "agent", 1, 17, context)
		effect.trait("C_Minister_Industrialist", "agent", 1, 17, context)
		effect.trait("C_Feck_Vice", "agent", 1, 17, context)
		effect.trait("C_Sausage_Vice", "agent", 1, 17, context)
		effect.trait("C_Sausage_Vice", "agent", 1, 17, context)
...
--[[ C_Minister_Created_Trigger_02_Army ]]--
...
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("army", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Army_Good", "agent", 1, 33, context)
...
--[[ C_Minister_Created_Trigger_03_Finance ]]--

events.CharacterCreated[#events.CharacterCreated+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("finance", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Fiscal_Genius", "agent", 1, 33, context)
		effect.trait("C_Minister_Fiscal_Genius", "agent", 2, 17, context)
		effect.trait("C_Minister_Trader", "agent", 1, 17, context)
		effect.trait("C_Minister_Trader", "agent", 1, 17, context)
		return true
	end
	return false
...
--[[ C_Minister_Created_Trigger_04_Head ]]--

events.CharacterCreated[#events.CharacterCreated+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("head_of_government", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Navy_Good", "agent", 1, 17, context)
		effect.trait("C_Minister_Army_Good", "agent", 1, 17, context)
		effect.trait("C_Minister_Fiscal_Genius", "agent", 1, 17, context)
		effect.trait("C_Minister_Unjust", "agent", 1, 17, context)
		effect.trait("C_Minister_Upright", "agent", 1, 17, context)
		effect.trait("C_Minister_Reactionary", "agent", 1, 17, context)
		return true
	end
	return false
...
--[[ C_Minister_Created_Trigger_05_Justice ]]--
...
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("justice", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Unjust", "agent", 1, 33, context)
		effect.trait("C_Minister_Unjust", "agent", 2, 17, context)
		effect.trait("C_Minister_Upright", "agent", 1, 33, context)
...
--[[ C_Minister_Created_Trigger_06_Navy ]]--

events.CharacterCreated[#events.CharacterCreated+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("navy", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Navy_Good", "agent", 1, 33, context)
...
events.BuildingCompleted[#events.BuildingCompleted+1] =
function (context)
	if (conditions.IsBuildingInChain("happiness", context) or conditions.IsBuildingInChain("culture", context)) and conditions.CharacterType("minister", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.ResearchCompleted[#events.ResearchCompleted+1] =
function (context)
	if (conditions.ResearchType("enlightenment_joint_stock_companies", context) or conditions.ResearchType("enlightenment_free_trade_doctrine", context) or conditions.ResearchType("enlightenment_abolition_of_slavery", context) or conditions.ResearchType("enlightenment_national_debt", context) or conditions.ResearchType("enlightenment_division_of_labour", context) or conditions.ResearchType("enlightenment_wealth_of_nations", context)) and conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("finance", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Fiscal_Genius", "agent", 1, 17, context)
		effect.trait("C_Minister_Fiscal_Genius", "agent", 1, 17, context)
		return true
	end
...
events.BuildingCompleted[#events.BuildingCompleted+1] =
function (context)
	if (conditions.IsBuildingInChain("industry-metal", context) or conditions.IsBuildingInChain("industry-pottery", context) or conditions.IsBuildingInChain("industry-textile", context)) and conditions.CharacterType("minister", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("finance", context) and conditions.PercentageUnspentIncome(context) >= 50 and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.BuildingCompleted[#events.BuildingCompleted+1] =
function (context)
	if conditions.IsBuildingInChain("navy-admin", context) and conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("navy", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.ResearchCompleted[#events.ResearchCompleted+1] =
function (context)
	if (conditions.ResearchType("enlightenment_joint_stock_companies", context) or conditions.ResearchType("enlightenment_free_trade_doctrine", context) or conditions.ResearchType("enlightenment_abolition_of_slavery", context) or conditions.ResearchType("enlightenment_national_debt", context) or conditions.ResearchType("enlightenment_division_of_labour", context) or conditions.ResearchType("enlightenment_wealth_of_nations", context)) and conditions.CharacterType("minister", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Minister_Trader", "agent", 1, 17, context)
		effect.trait("C_Minister_Trader", "agent", 1, 17, context)
		return true
	end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterType("minister", context) and conditions.CharacterMinisterialPosition("justice", context) and conditions.InsurrectionCrushed(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterInTheatre(1, context) and (conditions.CharacterType("catholic_missionary", context) or conditions.CharacterType("indian_missionary", context) or conditions.CharacterType("middle_east_missionary", context) or conditions.CharacterType("orthodox_missionary", context) or conditions.CharacterType("Protestant_Missionary", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Missionary_Gone_Native", "agent", 1, 5, context)
		return true
	end
	return false
end
...
function (context)
	if conditions.CharacterInTheatre(1, context) and (conditions.CharacterType("catholic_missionary", context) or conditions.CharacterType("indian_missionary", context) or conditions.CharacterType("middle_east_missionary", context) or conditions.CharacterType("orthodox_missionary", context) or conditions.CharacterType("Protestant_Missionary", context)) and conditions.RandomPercentCampaign(15, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Missionary_Hate_America", "agent", 1, 1, context)
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.CharacterInTheatre(2, context) and (conditions.CharacterType("catholic_missionary", context) or conditions.CharacterType("indian_missionary", context) or conditions.CharacterType("middle_east_missionary", context) or conditions.CharacterType("orthodox_missionary", context) or conditions.CharacterType("Protestant_Missionary", context)) and conditions.RandomPercentCampaign(15, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.RandomPercentCampaign(50, context) and not conditions.InSettlement(context) and not conditions.NoActionThisTurn(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("minister", context) or conditions.IsFactionLeader(context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
events.CharacterTurnEnd[#events.CharacterTurnEnd+1] =
function (context)
	if conditions.InSettlement(context) and conditions.NoActionThisTurn(context) and conditions.RandomPercentCampaign(50, context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("rake", context) or conditions.CharacterType("assassin", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Rake_Born_Bounder", "agent", 1, 33, context)
		effect.trait("C_Rake_Born_Bounder", "agent", 1, 17, context)
		effect.trait("C_Rake_Born_Bounder", "agent", 1, 17, context)
		effect.trait("C_Rake_Im_A_Laydee", "agent", 1, 8, context)
		effect.trait("C_Rake_Im_A_Laydee", "agent", 1, 8, context)
		return true
	end
	return false
...
function (context)
	if (conditions.CharacterType("rake", context) or conditions.CharacterType("assassin", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Rake_Assassin_Good", "agent", 1, 30, context)
		effect.trait("C_Rake_Naughty_Club", "agent", 1, 4, context)
		return true
	end
	return false
end
...
function (context)
	if (conditions.CharacterType("rake", context) or conditions.CharacterType("assassin", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Rake_Sabot_Good", "agent", 1, 90, context)
		effect.trait("C_Rake_Naughty_Club", "agent", 1, 4, context)
		return true
	end
	return false
...
function (context)
	if (conditions.CharacterType("rake", context) or conditions.CharacterType("assassin", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("C_Rake_Naughty_Club", "agent", 1, 10, context)
		effect.trait("C_Rake_Spy_Good", "agent", 1, 65, context)
		return true
	end
	return false
end
...
--[[ U_Acclimatised_Americas_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.UnitInTheatre("1", context) and not conditions.UnitCultureType("tribal", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Acclimatised_Europe_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.UnitInTheatre("2", context) and not conditions.UnitCultureType("european", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Acclimatised_India_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.UnitInTheatre("3", context) and not conditions.UnitCultureType("indian", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Acclimatised_Middle_East_Trigger ]]--

events.DummyEvent[#events.DummyEvent+1] =
function (context)
	if conditions.UnitOnContinent("cont_middle_east", context) and not conditions.UnitCultureType("middle_east", context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_American_Expert_Troops_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitInTheatre("1", context) and not conditions.UnitCultureType("tribal", context) and conditions.UnitWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Bright_Sabres_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitCategory("cavalry", context) and not conditions.UnitClass("cavalry_missile", context) and false then
		return true
	end
	return false
end

--[[ U_Cold_Steel_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitFoughtInMelee(context) and false then
		return true
	end
	return false
end

--[[ U_European_Expert_Troops_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitInTheatre("2", context) and not conditions.UnitCultureType("european", context) and conditions.UnitWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Indian_Expert_Troops_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitInTheatre("3", context) and not conditions.UnitCultureType("indian", context) and conditions.UnitWonBattle(context) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		return true
	end
	return false
end

--[[ U_Infected_Cholera_Trigger ]]--
...
--[[ U_Infected_Dengue_Fever_Trigger ]]--
...
--[[ U_Infected_Yellow_Fever_Trigger ]]--

events.UnitTurnEnd[#events.UnitTurnEnd+1] =
function (context)
	if false then
		return true
	end
...
--[[ U_Magic_Talismans_Trigger_01 ]]--

events.UnitCreated[#events.UnitCreated+1] =
function (context)
	if conditions.UnitCultureType("tribal", context) and (conditions.UnitType("native_american_archers", context) or conditions.UnitType("native_american_elite", context) or conditions.UnitType("native_american_mounted_lancers", context) or conditions.UnitType("native_american_tribesmen", context) or conditions.UnitType("native_american_warriors", context)) and not conditions.CampaignName("episodic_1", context) and not conditions.CampaignName("episodic_3", context) then
		effect.trait("U_Magic_Talismans", "unit", 1, 17, context)
		return true
	end
	return false
end

--[[ U_Magic_Talismans_Trigger_02_postbattle ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if conditions.UnitWonBattle(context) and conditions.UnitCultureType("tribal", context) and false then
		effect.trait("U_Magic_Talismans", "unit", 1, 17, context)
		return true
	end
	return false
...
--[[ U_Magic_Talismans_Trigger_03_loss ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if not conditions.UnitWonBattle(context) and conditions.UnitRouted(context) and false then
		effect.remove_trait("U_Magic_Talismans", unit, context)
		return true
	end
	return false
end

--[[ U_Prime_Mover_Trigger ]]--

events.UnitTurnEnd[#events.UnitTurnEnd+1] =
function (context)
	if conditions.UnitCategory("artillery", context) and false then
		return true
	end
	return false
end

--[[ U_Repressive_Policing_Trigger_01 ]]--

events.UnitTurnEnd[#events.UnitTurnEnd+1] =
function (context)
	if false then
		effect.trait("U_Repressive_Policing", "unit", 1, 17, context)
		return true
	end
	return false
end

--[[ U_Sharpshooters_Trigger ]]--
...
--[[ U_Ship_Boarding_Attack_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if (conditions.CampaignBattleType("naval_normal", context) or conditions.CampaignBattleType("naval_blockade", context) or conditions.CampaignBattleType("naval_breakout", context)) and conditions.UnitFoughtInMelee(context) and false then
		return true
	end
	return false
end

--[[ U_Ship_Boarding_Defence_Trigger ]]--

events.UnitCompletedBattle[#events.UnitCompletedBattle+1] =
function (context)
	if (conditions.CampaignBattleType("naval_normal", context) or conditions.CampaignBattleType("naval_blockade", context) or conditions.CampaignBattleType("naval_breakout", context)) and conditions.UnitFoughtInMelee(context) and not false then
		return true
	end
	return false
end
